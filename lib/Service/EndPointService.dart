...
class EndPointService extends ApiService {
  ...
  @override
  String baseUrl = 'https://shop.dinavision.org/api/v2';
}
...
abstract class ApiService {
  String baseUrlW = 'https://workshop.dinavision.org/api/v1';
  List includes;
  String baseName;
  String baseUrl;
  String parameter = "";
  ...
  Future<File> getImageFromGallery(int id, String property) async {
    String url = "https://workshop.dinavision.org/api/v1/Person/uploadImage";
  ...
  Future<dynamic> uploadImage(File data, int id) async {
    try {
      ...
      String url =
          "https://workshop.dinavision.org/api/v1/Person/UploadImage";
  ...
  Future<dynamic> uploadVoice(File data, int id) async {
    try {
      ...
      String url =
          "https://workshop.dinavision.org/api/v1/Person/uploadvoice";
      var response = await dio.post(url, data: fd);
...
//   Future<dynamic> uploadFile(String fileName, File data, int id, String property , String url) async {
//     try {
//       Dio dio = new Dio();
